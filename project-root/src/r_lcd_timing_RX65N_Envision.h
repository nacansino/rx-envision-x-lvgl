...
*******************************************************************************/
/******************************************************************************
* File Name    : r_lcd_timing_RX65N_Envision.h
...
Macro definitions
******************************************************************************/
#define     LCD_CH0_W_VSYNC         (1u)                    /* Vertical Pulse Width(VPW)                                   */
#define     LCD_CH0_DISP_VS         (1u + 7u)                    /* LCD display area vertical start position
                                                                 = Vertical Pulse Width(VPW) + Vertical Back Porch(VBP)     */
#define     LCD_CH0_DISP_VW         (272u)                   /* Vertical Display Period(VDP)                                */

#define     LCD_CH0_W_HSYNC         (25u)                    /* Horizontal Pulse Width(HPW)                                 */
#define     LCD_CH0_DISP_HS         (25u + 62u)                    /* LCD display area horizontal start position
                                                                 = Horizontal Pulse Width(HPW) + Horizontal Back Porch(HBP) */
#define     LCD_CH0_DISP_HW         (480u)                   /* Horizontal Display Period(HDP)                              */

#define     LCD_CH0_SIG_FV          (288u)              /* Vertical Total Period(VTP)                                  */
#define     LCD_CH0_SIG_FH          (584u)             /* Horizontal Total Period(HTP)                                */
